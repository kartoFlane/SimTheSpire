...
public enum MutableCombatValueEvents implements MutableCombatValueEvent {
    ENTITY_INCOMING_DAMAGE_ATTACK_FLAT("ENTITY_INCOMING_DAMAGE_ATTACK_FLAT"),
    ENTITY_INCOMING_DAMAGE_ATTACK_PERCENT("ENTITY_INCOMING_DAMAGE_ATTACK_PERCENT"),
    ENTITY_OUTGOING_DAMAGE_ATTACK_FLAT("ENTITY_OUTGOING_DAMAGE_ATTACK_FLAT"),
    ENTITY_OUTGOING_DAMAGE_ATTACK_PERCENT("ENTITY_OUTGOING_DAMAGE_ATTACK_PERCENT"),
    ENTITY_INCOMING_DAMAGE_SKILL_FLAT("ENTITY_INCOMING_DAMAGE_SKILL_FLAT"),
    ENTITY_INCOMING_DAMAGE_SKILL_PERCENT("ENTITY_INCOMING_DAMAGE_SKILL_PERCENT"),
    ENTITY_OUTGOING_DAMAGE_SKILL_FLAT("ENTITY_OUTGOING_DAMAGE_SKILL_FLAT"),
    ENTITY_OUTGOING_DAMAGE_SKILL_PERCENT("ENTITY_OUTGOING_DAMAGE_SKILL_PERCENT"),
